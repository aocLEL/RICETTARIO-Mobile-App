...
<View style={styles.container}>
    ...
    <Text style={{marginBottom: 80, fontSize: 50, alignItems: 'center', fontFamily: 'Cookies',}}>Accedi</Text>
  ...
  <View style={styles.inputContainer}>
      ...
      <TouchableOpacity onPress={SignInSendData} style={{marginTop: 30}}>
              <Text style={styles.SignUpButton}>Accedi</Text>
     </TouchableOpacity>
  </View>
</View>
  ); } else {
